...
| `package/src/components/Provider/AudioPlayerRootProvider.tsx`       | `<Provider theme={theme}>` | native `<div>` with CSS position handling |
...
package/src/components/Provider/AudioPlayerRootProvider.tsx  # @react-spectrum 제거
