...
import type { AudioPlayerContainerProps } from "@/audio-player/Container/AudioPlayerContainer";
import type { UIContext } from "@/audio-player/Context/UIContext";
import type { PlayerPlacement } from "@/audio-player/Context/StateContext";

vi.mock("@/audio-player/Context/hooks/useUIContext");
